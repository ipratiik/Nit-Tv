  ...
  return (
    ...
    >
      ...
      <section className="container flex flex-col gap-8 md:gap-10">
        <header className="flex justify-between rounded-xl bg-emerald-500/30 w-full md:w-2xl lg:w-5xl mx-auto">
        ...
        <main className="relative z-20 flex flex-col items-center gap-8 overflow-hidden rounded-3xl border-2 border-gray-400 py-12 md:py-16 shadow-2xl">
          ...
          <div className="z-10 text-center text-xm font-bold max-w-5xl md:hidden">
            <p>
