        ...
        <div className="flex flex-col justify-between">
          <div className="hidden justify-center gap-4 md:flex">
            {!isStarted ? (
              ...
              <div className="grid w-full gap-5 lg:grid-cols-2">
                <button
                  className="cursor-pointergap-2 flex items-center justify-center rounded-xl border border-blue-200 bg-gradient-to-b from-cyan-400 via-sky-500 to-blue-600 px-2 py-1 font-medium text-white shadow-xl hover:shadow-2xl md:px-6 md:py-1.5 md:text-xl"
                  onClick={handleNext}
                >
                  <p>Next </p>
                  <CircleArrowRight strokeWidth={2.5} />
